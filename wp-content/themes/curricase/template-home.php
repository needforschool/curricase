...
<section id="first">
        <div class="first-wrapper container">
            <div class="first-text">
                ...
                <a href="<?php echo esc_url(home_url('login')); ?>" class="btn btn-one">Créer un compte gratuit</a>
            </div>
    ...
    <section id="third">
        <div class="third-wrapper container">
            ...
            <a href="<?php echo esc_url(home_url('login')); ?>" class="btn btn-two">Inscrivez-vous Gratuitement</a>
